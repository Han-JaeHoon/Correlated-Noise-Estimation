...
\begin{tikzpicture}[scale=1, cell/.style={draw=Ocean, minimum size=3.2mm,
  ...
  \begin{scope}[shift={(0,0)}]
    ...
    \node[font=\footnotesize\itshape, text width=3.4cm, align=center] at (1.2,-2.35)
  ...
  \begin{scope}[shift={(5.2,0)}]
    ...
    \node[font=\footnotesize\itshape, text width=3.6cm, align=center] at (1.2,-2.35)
...
\vspace{2mm}
\keyfig{figures/fig_acc_vs_T.png}{0.86\linewidth}{%
  Temporal accuracy vs sequence length $T$ (three fault-model scenarios). The
  \textbf{GRU} (blue) climbs with $T$ to \bignum{$\approx\!95\%$}{(R2)}, breaking the
  rule-based single-round ceiling ($0.75$); RNN / transformer lag.}

\vspace{1mm}
\innerblock{Headline (preliminary)}{
Temporal GRU $\approx95\%$; spatial LogReg $\approx94\%$ at $N{=}300$. Reported as
in-progress, not final performance claims.}
}
